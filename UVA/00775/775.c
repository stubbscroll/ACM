/* solution to 775 using frank rubin's algorithm from the paper
...
/* WARNING, for very dense graphs consider plain backtracking instead.
   also, several of the admissibility checks can be removed to save time
   for dense graphs */
...
int admissible(int d) {
	...
	do {
		...
		/* F6: fail is graph is disconnected */
		if(!reach()) return 0;
