/* solution for raw data, easy input. must be run 3 times.
   this is identical to the hard solution, with the exception of a hardcoded
   url */
...
void submitPOST() {
	...
	if(curl) {
		setcookie();
		curl_easy_setopt(curl,CURLOPT_URL,"https://ipsc.ksp.sk/2018/practice/problems/r1");
